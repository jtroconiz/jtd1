  ...
  return (
    <header id="home" className={`fixed w-full top-0 bg-custom-blue z-50 p-2 ${open ? 'bg-custom-blue' : ''}`}>
      <div className="flex items-center justify-between">
        ...
        <ul className={`lg:flex text-3xl lg:items-center lg:pb-0 lg:pt-0 pb-12 absolute lg:static left-0 w-full lg:w-auto lg:pl-0 pl-9 transition-all duration-1000 ease-in ${open ? 'top-[100%] opacity-100 bg-custom-blue h-200 w-hv' : 'top-[-490px] opacity-0'} z-20`}>
